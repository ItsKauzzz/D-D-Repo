...
$('#menuExportPng').onclick = () => { closeAppMenus(); redraw(true, false); downloadFile('mapa-render-final.png', canvas.toDataURL('image/png'), 'image/png'); redraw(); };
