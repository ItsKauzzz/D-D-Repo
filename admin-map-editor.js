...
function renderPathPresets(selectedId) {
  ...
  $('#pathStroke').value = preset?.stroke ?? 8; $('#pathColor').value = preset?.color || '#c99b57'; $('#pathDashed').checked = preset?.dashed || false;
}
...
$('#savePathPreset').onclick = () => {
  ...
  const values = { name: $('#pathPresetName').value.trim() || `Preset ${state.pathPresets.length + 1}`, stroke: Number($('#pathStroke').value), color: $('#pathColor').value, dashed: $('#pathDashed').checked };
